...
class TestSDXClient(unittest.TestCase):
    ...
    def test_notifications_not_list(self):
        ...
        self.assert_valid_notifications(invalid_notifications, ERROR_NOTIFICATIONS_NOT_LIST)
    ...
    def test_notifications_list_element_not_dict(self):
        ...
        self.assert_valid_notifications(invalid_notifications, ERROR_NOTIFICATION_ITEM_NOT_DICT)
    ...
    def test_notifications_dict_no_email_key(self):
        ...
        self.assert_valid_notifications(invalid_notifications, ERROR_NOTIFICATION_ITEM_EMAIL_KEY)
    ...
    def test_notifications_dict_non_valid_email(self):
        ...
        self.assert_valid_notifications(invalid_notifications, ERROR_NOTIFICATION_INVALID_EMAIL_FORMAT)
    ...
    def test_notifications_list_too_long(self):
        ...
        self.assert_valid_notifications(exceeding_notifications, ERROR_NOTIFICATION_EXCEEDS_LIMIT)
